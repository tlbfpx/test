...
public class MoneyUtil {
    ...
    public static String cent2Yuan(BigDecimal amount) {
        return amount.divide(new BigDecimal(100), 1, ROUNDING_MODE).doubleValue() + "";
    }

    public static String cent2YuanToScale2(BigDecimal amount) {
        return amount.divide(new BigDecimal(100), 2, ROUNDING_MODE).doubleValue() + "";
    }

    public static String cent2Yuan(BigDecimal amount, int scale) {
        return amount.divide(new BigDecimal(100), scale, ROUNDING_MODE).toPlainString();
    }
    ...
    public static String cent2YuanToScale2(String amount) {
        return cent2YuanToScale2(new BigDecimal(amount));
    }
    ...
    public static String cent2Yuan(long amount, int scale) {
        return cent2Yuan(new BigDecimal(amount), scale);
    }
    ...
    public static int yuan2Cent(String amount) {
        if (StringUtils.isBlank(amount)) {
            return 0;
        }
        return new BigDecimal(amount).multiply(new BigDecimal(100), new MathContext(16, ROUNDING_MODE))
     ...
     * @return
     */
    public static String retainOneDecimal(int value) {
    ...
    public static void main(String[] args) {
        Double a = 1.54;
        System.out.println(new BigDecimal(a).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
    }
