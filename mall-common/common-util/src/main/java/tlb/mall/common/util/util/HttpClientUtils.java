...
public class HttpClientUtils {
    ...
    public static String postJsonParameters(String url, String parameterStr)
        ...
        return post(url, parameterStr, "application/json", charset,
    ...
    public static String postParameters(String url)
            throws ConnectTimeoutException, SocketTimeoutException, Exception {
        return post(url, null, "application/x-www-form-urlencoded", charset,
                connTimeout, readTimeout);
    }
    ...
    public static void main(String[] args) throws ConnectTimeoutException,
        ...
        try {
            String a = get(
                    "https://detail.m.tmall.com/item.htm?id=538997480308",
                    "GBK");
