        ...
        "columnDefs": [
            {
                ...
                "render": function(data, type, full) {
                	return "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"hrAuditHandle(' ','" + $("#toHrAuditHandleUrl").val() + "?taskId=" + data + "','')\" href=\"javascript:;\" title=\"请假申请审批\"><i class=\"Hui-iconfont\">&#xe6df;</i></a>";
                }
            }
        ],
 ...
 * @param value
 */
function hrAuditHandle(title,url,data){
