...
$(function () {
    ...
    table = $(".table-sort").dataTable({
        ...
        columns: [
            ...
            { "data": "deploymentId" , "bSortable": false , width : "10%"},
            { "data": "name" , "bSortable": false, width : "20%"},
            { "data": "resourceName", width : "15%", "bSortable": false},
            { "data": "diagramResourceName", width : "15%", "bSortable": false},
            { "data": "key" , width : "10%", "bSortable": false}
        ],
        ...
        "columnDefs": [
			{
			    ...
			    "render": function(data, type, full) {
			         return '<a style=\"text-decoration:underline;color:red;\" title="点击可查看文件内容" target="_blank" href="' + $("#basePathUrl").val() + '/activiti/showProcessResource?processDeploymentId=' + full.id + '&resource=' + data + '">' + data + '</a>';
			    }
			},
            {
                "targets": [4],
                ...
                "render": function(data, type, full) {
                	return '<a style=\"text-decoration:underline;color:red;\" title="点击查看流程图" target="_blank" href="' + $("#basePathUrl").val() + '/activiti/showProcessResource?processDeploymentId=' + full.id + '&resource=' + data + '">' + data + '</a>';
                }
            },
            {
                "targets": [6],
                "data": "userId",
                "render": function(data, type, full) {
                	return "<a style=\"text-decoration:none;margin-left:15px;\" class=\"ml-5\" onClick=\"deleteProcess('" + full.deploymentId + "')\" href=\"javascript:;\" title=\"删除\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>";
                }
            }
        ],
