...
$(function () {
    ...
    table = $(".table-sort").dataTable({
        ...
        ajax: function (data, callback, settings) {
            ...
            $.ajax({
                type: "POST",
                url: $("#getMyLeaveApplyTurndownListUrl").val(),
                cache: false,  //禁用缓存
                data: param,  //传入组装的参数
                dataType: "json",
                timeout:10000,
        ...
        "columnDefs": [
            {
                ...
                "render": function(data, type, full) {
                	return "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"leaveApplyModifyHandle(' ','" + $("#toLeaveApplyModifyViewUrl").val() + "?taskId=" + data + "','')\" href=\"javascript:;\" title=\"重新提交申请\"><i class=\"Hui-iconfont\">&#xe6df;</i></a>";
                }
            }
        ],
 ...
 * @param value
 */
function leaveApplyModifyHandle(title,url,data){
