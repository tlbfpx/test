...
$(function () {
    ...
    table = $(".table-sort").dataTable({
        ...
        columns: [
            { "data": "executionId" , "bSortable": false ,width : "15%"},
            { "data": "processInstanceId" , "bSortable": false , width : "10%"},
            { "data": "name" , "bSortable": false, width : "20%"},
            { "data": "businessKey", width : "15%", "bSortable": false}
        ],
        ...
        "columnDefs": [
            {
                ...
                "render": function(data, type, full) {
                	return '<a style=\"text-decoration:underline;\" title="点击查看当前流程进度" target="_blank" href="' + $("#basePathUrl").val() + '/oa/traceProcess/' + full.processInstanceId + '">查看详情</a>';
                }
            }
        ],
