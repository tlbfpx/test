    ...
    table = $(".table-sort").dataTable({
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "data": "id",
                "render": function(data, type, full) {
                	return "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"roleEdit('编辑角色信息','" + $("#toEditRoleUrl").val() + "?roleId=" + data + "','','','700')\" href=\"javascript:;\" title=\"编辑角色信息\"><i class=\"Hui-iconfont\">&#xe6df;</i></a>"
                             + "<a style=\"text-decoration:none;margin-left:15px;\" class=\"ml-5\" onClick=\"roleDelete('" + data + "')\" href=\"javascript:;\" title=\"删除\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>";
                }
            }
        ],
...
/* 角色-添加*/
function roleAdd(title,url,id,w,h){
...
function roleEdit(title,url,id,w,h){
	...
	if(haveRoleEditPermission != undefined && haveRoleEditPermission != ""){
		layer_show(title,url,w,h);
	}else{
		layer.msg("您暂无角色修改权限", {
            shift: 2,
...
function roleDelete(roleId){
	...
	if(haveRoleDeletePermission != undefined && haveRoleDeletePermission != ""){
		$.confirm({
	        icon: '',
	        content: '确定删除该角色信息？',
	        confirm: function(){
