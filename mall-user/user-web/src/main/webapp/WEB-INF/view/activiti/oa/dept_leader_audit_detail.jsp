...
<head>
    ...
    <script type="text/javascript" src="${ctx}/resources/js/activiti/oa/dept_leader_audit_detail.js"></script>
</head>
<body>
    <nav class="breadcrumb">
        <i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> activiti工作流管理 <span class="c-gray en">&gt;</span> 请假申请审批
    ...
    <article class="page-container">
        <form action="${ctx}/oa/deptleader/audit/handle" method="post" class="form form-horizontal" id="deptLeaderAuditDetailForm">
            <!-- 任务ID -->
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-1">审批意见：</label>
                <div class="formControls col-xs-8 col-sm-4">
                    <span class="select-box">
                        <select class="select" name="deptleaderApproveResult" id="deptleaderApproveResult">
