...
<body>
    <nav class="breadcrumb">
        <i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> activiti工作流管理 <span class="c-gray en">&gt;</span> 部门经理审批
    ...
    <div class="page-container">
        <div class="mt-20">
            <table id="deptleaderAuditListTable" class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
                <thead>
                    <tr class="text-c">
                        <th>申请人</th>
                        <th>请假类型</th>
	...
	<input des="获取部门领导需要审批的请假流程列表url" type="hidden" name="getDeptLeaderAuditListUrl" id="getDeptLeaderAuditListUrl" value="<c:url value="/oa/deptleader/auditlist"/>" />
	<input des="审批请假申请页面url" type="hidden" name="toDeptLeaderAuditHandleUrl" id="toDeptLeaderAuditHandleUrl" value="<c:url value="/oa/deptleader/audit/view"/>" />
