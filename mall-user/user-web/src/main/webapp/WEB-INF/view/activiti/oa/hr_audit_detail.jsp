...
<body>
    ...
    <article class="page-container">
        <form action="${ctx}/oa/hr/audit/handle" method="post" class="form form-horizontal" id="hrAuditDetailForm">
            <!-- 任务ID -->
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-4">
                    <span class="select-box">
                        <select class="select" name="hrApproveResult" id="hrApproveResult">
